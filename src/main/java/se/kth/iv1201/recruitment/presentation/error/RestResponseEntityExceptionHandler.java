...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler implements ErrorController {
     ...
     *
     * @return An HTTP response with relevant status and response body.
     */
    ...
    public ResponseEntity<?> handleConflict(UsernameNotUniqueException ex, WebRequest request) {
    ...
    public ResponseEntity<?> handleConflict(EmailNotUniqueException ex, WebRequest request) {
